...
function ChangePassword() {
  ...
  <div className="flex-grow p-6 mt-10 md:mt-0">
    {/* Header */}
    <h2 className="text-2xl font-extrabold mb-6 text-blue-800 border-b-4 border-blue-500 pb-2">
      Change Password
    </h2>

    {/* Form */}
    <form onSubmit={handleSubmit} className="max-w-md mx-auto bg-white p-6 shadow-md rounded-xl mt-10">
      {/* New Password Field */}
      <div className="mb-6">
